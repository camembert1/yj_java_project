...
public class Condition3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("A사원 연봉/연봉+a : " + workerA + "/" + workerAi);
		System.out.println((workerAi >= 3000) ? "3000 이상" : "3000 미만");
	
		System.out.println("B사원 연봉/연봉+a : " + workerB + "/" + workerBi);
		System.out.println((workerBi >= 3000) ? "3000 이상" : "3000 미만");
		
		System.out.println("C사원 연봉/연봉+a : " + workerC + "/" + workerCi);
		System.out.println((workerCi >= 3000) ? "3000 이상" : "3000 미만");
	}
}
